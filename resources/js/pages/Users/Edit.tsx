...
const users:any = usePage().props.user;

    const { data, setData, put, processing } = useForm({
        name: users.name,
        email: users.email,
        password: '',
        role: users.roles[0] != null && users.roles[0].name,
    });
                ...
                <Card className="flex align-center justify-between">
                   ...
                   <CardContent>
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <select defaultValue={data.role} name="role" id="role" className="mt-1 block w-full border mb-3 rounded text-md p-2 border-gray-300  focus:border-indigo-500 focus:ring-indigo-500 " onChange={(e) => setData('role', e.target.value )}>
